...
export enum Routes {
  ...
  ForzaBestDragCars = '/games/forza/best-drag-cars',
  ForzaBestDriftCars = '/games/forza/best-drift-cars',
  ForzaCarList = '/games/forza/car-list',
  ...
  ForzaHorizon6JapanMap = '/games/forza-horizon-6/japan-map',
  ...
  ForzaHorizon6Ps5Release = '/games/forza-horizon-6/ps5-release',
  ...
  ForzaHorizon6Settings = '/settings/forza-horizon-6',
