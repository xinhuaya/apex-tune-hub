...
export function formatResultForClipboard(
  ...
  return [
    ...
    'Car:',
    'Route or event:',
    'Target class and drivetrain:',
    'Starting symptom:',
    'Change made:',
    'Run 1 result:',
    'Run 2 result:',
    'Decision: keep / soften / revert',
    '',
    'Baseline rules',
    'Change one setting group at a time.',
    'Use the same route, assists, weather, and launch point when comparing.',
    'Keep the tune only when the second run is easier to repeat than the first.',
    '',
