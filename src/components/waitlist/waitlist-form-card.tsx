    ...
    <Card className="forza-panel mx-auto w-full max-w-lg overflow-hidden pt-6 pb-0 text-zinc-50">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <CardFooter className="mt-6 flex items-center justify-between rounded-none border-t border-zinc-800 bg-zinc-950/70 px-6 py-4">
            <Button
              type="submit"
              disabled={isPending}
              className="forza-primary-button"
            >
