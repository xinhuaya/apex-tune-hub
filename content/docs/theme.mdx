...
![Neutral](https://cdn.mksaas.com/images/docs/themes/neutral.png)

    </Tab>

    <Tab value='black'>

![Black](https://cdn.mksaas.com/images/docs/themes/black.png)

    </Tab>

    <Tab value='vitepress'>

![Vitepress](https://cdn.mksaas.com/images/docs/themes/vitepress.png)

    </Tab>

    <Tab value='dusk'>

![Dusk](https://cdn.mksaas.com/images/docs/themes/dusk.png)

    </Tab>

    <Tab value='Catppuccin'>

![Catppuccin](https://cdn.mksaas.com/images/docs/themes/catppuccin.png)

    </Tab>

    <Tab value='ocean'>

![Ocean](https://cdn.mksaas.com/images/docs/themes/ocean.png)

    </Tab>

    <Tab value='purple'>

![Purple](https://cdn.mksaas.com/images/docs/themes/purple.png)
